...
//  Off-chain signature gathering ScWallet that streams funds - @austingriffith
//
...
import "./ScWalletFactory.sol";

contract ScWallet {
    using ECDSA for bytes32;
    ScWalletFactory private scWalletFactory;
    ...
    constructor(uint256 _chainId, address[] memory _owners, uint _signaturesRequired, address _factory) payable {
        ...
        scWalletFactory = ScWalletFactory(_factory);
